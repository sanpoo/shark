...
#define HTTP_STATUS_OFFSET_4XX  (HTTP_STATUS_LAST_3XX - 301 + HTTP_STATUS_OFFSET_3XX)
...
#define HTTP_STATUS_OFFSET_5XX  (HTTP_STATUS_LAST_4XX - 400 + HTTP_STATUS_OFFSET_4XX)
...
#define HTTP_ERROR_OFFSET_494   (HTTP_ERROR_LAST_4XX - 400 + HTTP_ERROR_OFFSET_4XX)
...
static inline str_t *get_http_status_line(int ret_code)
{
    ...
    else if (ret_code >= HTTP_MOVED_PERMANENTLY && ret_code < HTTP_STATUS_LAST_3XX)
        status_line = &http_status_lines[ret_code - HTTP_MOVED_PERMANENTLY + HTTP_STATUS_OFFSET_3XX];
    else if (ret_code >= HTTP_BAD_REQUEST && ret_code < HTTP_STATUS_LAST_4XX)
        status_line = &http_status_lines[ret_code - HTTP_BAD_REQUEST + HTTP_STATUS_OFFSET_4XX];
    else if (ret_code >= HTTP_INTERNAL_SERVER_ERROR && ret_code < HTTP_STATUS_OFFSET_LAST)
        status_line = &http_status_lines[ret_code - HTTP_INTERNAL_SERVER_ERROR + HTTP_STATUS_OFFSET_5XX];
    else
    {
...
static inline str_t *get_http_error_page(int ret_code)
{
    ...
    if (ret_code >= HTTP_MOVED_PERMANENTLY && ret_code < HTTP_ERROR_LAST_3XX)
        ...
        error_page = &http_error_pages[ret_code - HTTP_BAD_REQUEST + HTTP_ERROR_OFFSET_4XX];
